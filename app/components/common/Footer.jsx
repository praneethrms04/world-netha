            ...
            <div className="mb-16 grid grid-cols-2 gap-12 border-t pt-10 md:grid-cols-4 lg:grid-cols-6 lg:gap-8 lg:pt-12">
               ...
               <div>
                  ...
                  <nav className="flex flex-col gap-4">
                     <div>
                        <Link href="/" className="text-gray-700 transition duration-100 hover:text-indigo-500 active:text-indigo-600 font-bold">Home</Link>
                     </div>

                     <div>
                        <Link href="/" className="text-gray-700 transition duration-100 hover:text-indigo-500 active:text-indigo-600 font-bold">Featured male</Link>
                     </div>

                     <div>
                        <Link href="/" className="text-gray-700 transition duration-100 hover:text-indigo-500 active:text-indigo-600 font-bold">Featured Female</Link>
                     </div>

                     <div>
                        <Link href="/" className="text-gray-700 transition duration-100 hover:text-indigo-500 active:text-indigo-600 font-bold">Matched by Worldnetha</Link>
                     </div>
                  </nav>
               </div>
               <div>
                  ...
                  <nav className="flex flex-col gap-4">
                     <div>
                        <Link href="/" className="text-gray-700 transition duration-100 hover:text-indigo-500 active:text-indigo-600 font-bold">Search by gender</Link>
                     </div>

                     <div>
                        <Link href="/" className="text-gray-700 transition duration-100 hover:text-indigo-500 active:text-indigo-600 font-bold">Search by age</Link>
                     </div>

                     <div>
                        <Link href="/" className="text-gray-700 transition duration-100 hover:text-indigo-500 active:text-indigo-600 font-bold">Search by qualification</Link>
                     </div>

                     <div>
                        <Link href="/" className="text-gray-700 transition duration-100 hover:text-indigo-500 active:text-indigo-600 font-bold">Search by marital status</Link>
                     </div>
                  </nav>
               </div>
               ...
               <div className='flex flex-col gap-4'>
                  <div>
                     ...
                     <nav className="flex flex-col gap-4">
                        <div>
                           <Link href="/" className="text-gray-700 transition duration-100 hover:text-indigo-500 active:text-indigo-600 font-bold">Membership plans</Link>
                        </div>
                     </nav>
                  </div>
                  <div>
                     ...
                     <nav className="flex flex-col gap-4">
                        <div>
                           <Link href="/" className="text-gray-700 transition duration-100 hover:text-indigo-500 active:text-indigo-600 font-bold">Contact Us</Link>
                        </div>
                        <div>
                           <Link href="/" className="text-gray-700 transition duration-100 hover:text-indigo-500 active:text-indigo-600 font-bold">FAQs</Link>
                        </div>
                     </nav>
                  </div>
               </div>
               <div>
                  ...
                  <div className="flex gap-4">
                     ...
                     <Link href="/" target="_blank" className="text-gray-400 transition duration-100 mt-1 hover:text-gray-500 active:text-gray-600">
